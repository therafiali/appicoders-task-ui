    ...
    <header className="bg-red-brand text-white">
      <div className="mx-auto  px-24">
        <div className="flex h-32 items-center justify-between">
          ...
          <div className="md:flex hidden  md:flex-col  items-end justify-end gap-6">
            {/* Nav items */}
              ...
              <ul className="flex items-center gap-6">
                {HeaderItems.map((item) => (
                  <li key={item}>
                    <a
                      href="#"
                      className="inline-block px-1 py-2 text-white hover:text-white/90 transition-opacity hover:opacity-80 font-semibold text-xl  tracking-wide"
                    >
                      {item}
                    </a>
                  </li>
            ...
            >
              <Phone size={24} />
              <span className="text-xl font-semibold">+1 (800) 826-8018</span>
            </a>
          </div>
        </div>
      </div>
